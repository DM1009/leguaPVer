...
export default function LtDetail() {
    ...
    const getSinglePost = async () => {
      try {
        const res = await axios.get(
          `https://${baseUrl}/posts/get/lookTutorial/${id}`
        )
        setPost(res.data)
      } catch (error) {
        console.error(error)
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`https://${baseUrl}/posts/delete/lookTutorial/${id}`)
      navigate(`/look/tutorial`)
    } catch (error) {
      console.error(error)
    }
  }
