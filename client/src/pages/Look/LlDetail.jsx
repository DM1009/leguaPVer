...
import LlUpdate from '../Look/LlUpdate'
import AddCommentIcon from '@mui/icons-material/AddComment'
import { stringAvatar } from '../../components/Avatar'
import Comment from '../../components/Comment'
import SERVER_URL from '../../config'

export default function LlDetail() {
    ...
    const getSinglePost = async () => {
      try {
        const res = await axios.get(
          `https://${baseUrl}/posts/get/lookLesson/${id}`
        )
        setPost(res.data)
      } catch (error) {
        console.error(error)
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`https://${baseUrl}/posts/delete/lookLesson/${id}`)
      navigate(`/look/lesson`)
    } catch (error) {
      console.error(error)
    }
  }
