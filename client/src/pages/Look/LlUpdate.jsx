...
export default function LlUpdate({
  postTitle,
  postContent,
  postArea,
  postAge,
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    try {
      await axios.put(`https://${baseUrl}/posts/update/lookLesson/${id}`, {
      ...
      >
        ...
        <FormControl sx={{ m: 1, mr: 4, minWidth: 80 }}>
          ...
          <Select
            ...
            onChange={handleChange}
          >
            <MenuItem value={'피아노'}>피아노</MenuItem>
            <MenuItem value={'바이올린'}>바이올린</MenuItem>
            <MenuItem value={'기타(Guitar)'}>기타(Guitar)</MenuItem>
